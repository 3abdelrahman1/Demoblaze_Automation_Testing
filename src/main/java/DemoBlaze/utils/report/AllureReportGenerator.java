...
import DemoBlaze.utils.OSUtils;
import DemoBlaze.utils.TerminalUtils;
...
import static DemoBlaze.utils.dataReader.PropertyReader.getProperty;
import static DemoBlaze.utils.report.AllureConstants.HISTORY_FOLDER;
import static DemoBlaze.utils.report.AllureConstants.RESULTS_HISTORY_FOLDER;
...
public class AllureReportGenerator {
    ...
    public static String renameReport() {
        ...
        DemoBlaze.FileUtils.renameFile(AllureConstants.REPORT_PATH.resolve(AllureConstants.INDEX_HTML).toString(), newFileName);
        return newFileName;
    }
