...
public class ElementActions {
    ...
    public void Enter_PIP_JS(By locator) {
        ...
        ((org.openqa.selenium.JavascriptExecutor) driver)
                .executeScript("return arguments[0].requestPictureInPicture();",findElement(locator));
    }

    //assert that Element is in pip
    public Boolean assertPIP_Element(By locator) {
        Boolean pipIsElement = (Boolean)((org.openqa.selenium.JavascriptExecutor) driver)
                .executeScript("""
            return document.pictureInPictureElement === arguments[0];""", findElement(locator));

        return pipIsElement;
    }

    public void Exit_PIP_JS(By locator) {


        ((org.openqa.selenium.JavascriptExecutor) driver)
                .executeScript("document.exitPictureInPicture();");
    }
